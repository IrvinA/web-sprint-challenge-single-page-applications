...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    useRouteMatch is used to maintain the current data of any particular route.
    It is useful to use when constructing nested paths.

1. How would you explain form validation to someone who has never programmed before?

    Form validation is process in which we can make sure the user inputs the correct information to the correct form field 
    and return an error message if the information is missing, required, incorrect, etc. 

1. In 1-2 sentences, define end to end testing.

    End to end test is a methodology that is utilized to simulate data and circumstances that the application might experience in a live setting.
    It is a wide set of tests that can examine the functionality and performance of an application.
